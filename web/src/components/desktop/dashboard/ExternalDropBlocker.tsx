...
export function ExternalDropBlocker({ onFilesDropped, onUploadClick }: { onFilesDropped?: (files: File[]) => void; onUploadClick?: () => void }) {
    ...
    useEffect(() => {
        ...
        const handleDrop = (e: DragEvent) => {
            ...
            if (fileList.length > 0 && onFilesDroppedRef.current) {
                onFilesDroppedRef.current(fileList);
                setDroppedCount(fileList.length);
