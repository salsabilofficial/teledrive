...
import { Mail, UserPlus, LogIn, Loader2, Sun, Moon, Lock, Key } from 'lucide-react';
import { toast } from 'sonner';

// Mock hook or minimal Context override if not using ThemeContext
function useTheme() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        toast.success(body.message || 'Registration successful! You can now log in.');
        setIsSignUp(false);
